...
getViews(){
  return this.http.post<any>(`${this.API_URL}views`, HttpResponse)
}

get_data_based_on_view(viewName: any) {
  ...
  return this.http.post<any>(`${this.API_URL}data/${viewName}`,data)
}

get_columns(selectedLicense:any){
  return this.http.post<any>(`${this.API_URL}get_columns/${selectedLicense}`, HttpResponse)
}

generateReport(data:any){
  return this.http.post<any>(`${this.API_URL}report`, data)
  }
